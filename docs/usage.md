...
[← Product overview](../README.md) · [Architecture](design.md)
...
Files, credential files, permissions and plugin-private state do not automatically
move between machines. Text already present in conversation or tool results may be
included in the checkpoint. Checkpoints carry conversation context, not model KV caches.
